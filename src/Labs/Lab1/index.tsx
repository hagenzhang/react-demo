    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                My favorite recipe: Pan Fried Egg
                <ol id="wd-your-favorite-recipe">
                    <li>Heat up your pan on medium heat until water beads across the surface</li>
                    <li>Add oil into the pan, and let the oil heat up for a minute or two</li>
                    <li>Crack an egg into the pan</li>
                    <li>Add salt and pepper to taste</li>
                    <li>Cook on medium low heat until desired doneness</li>
                    <li>Serve and enjoy!</li>
                </ol>
            ...
            <div id="wd-images">
                ...
                <br />
                <img id="wd-starship"
                    alt="Humans in a metallic hot air balloon-like craft"
                    width="400px"
            ...
            <div>
                ...
                to get dummy text
                <br />
                <a id="wd-github" href="https://github.com/hagenzhang/react-demo">To Code Git Repo</a>
            </div>
        </div>
    );
}
