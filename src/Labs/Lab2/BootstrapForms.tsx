export function BootstrapFormsStyling() {
  return (
...
export function BootstrapFormsDropdowns() {
  return (
...
export function BootstrapFormsRangeAndSliders() {
  return (
...
export function BootstrapFormsResponsive1() {
  return (
...
export function BootstrapFormsResponsive2() {
  return (
