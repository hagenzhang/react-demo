      ...
      <table className="table table-striped">
        ...
        <tbody>
          <tr><td className="wd-full-name text-nowrap">
            ...
            <td className="wd-total-activity">09:12:02</td> </tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-01</td>
            <td className="wd-total-activity">08:31:24</td> </tr>

            <tr><td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Natasha</span>{" "}
              <span className="wd-last-name">Romanoff</span></td>
            <td className="wd-login-id">001234541S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-02</td>
            <td className="wd-total-activity">12:45:10</td> </tr>   
        </tbody>
      </table>
    </div> );}